...
var _user$project$Main$errorMessage = function (error) {
	...
	switch (_p0.ctor) {
		case 'BadUrl':
			return A2(_elm_lang$core$Basics_ops['++'], 'Invalid url: ', _p0._0);
		case 'Timeout':
		...
		default:
			var _p1 = _p0._0.status;
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'Server returned ',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(_p1.code),
					A2(_elm_lang$core$Basics_ops['++'], '. ', _p1.message)));
	}
};
var _user$project$Main$callWhenLoaded = F2(
	function (f, status) {
		var _p2 = status;
		switch (_p2.ctor) {
			case 'Success':
			...
			default:
				return _elm_lang$html$Html$text(
					_user$project$Main$errorMessage(_p2._0));
		}
	});
var _user$project$Main$timeRemaining = function (timeLeftMs) {
	var time = _elm_lang$core$Basics$ceiling(
		A3(
			...
			1000,
			timeLeftMs));
	var color = (_elm_lang$core$Native_Utils.cmp(time, 3) < 0) ? 'red' : ((_elm_lang$core$Native_Utils.cmp(time, 6) < 0) ? 'orange' : 'black');
	return A2(
...
var _user$project$Main$showScores = function (_p3) {
	var _p4 = _p3;
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Time left: '),
					_1: {
						ctor: '::',
						_0: _user$project$Main$timeRemaining(_p4.timeLeftMs),
						_1: {
							ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						...
						_elm_lang$core$Dict$toList(_p4.allScores))),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$encodeBody = F2(
	function (teamName, vote) {
			...
			_elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$string(
							_elm_lang$core$Basics$toString(vote))
					},
					_1: {
						ctor: '::',
						_0: {
...
var _user$project$Main$toCmd = function (msg) {
	return A2(
		_elm_lang$core$Task$perform,
		function (_p7) {
			return msg;
...
var _user$project$Main$sendDecoder = _elm_lang$core$Json_Decode$succeed(
	{ctor: '_Tuple0'});
var _user$project$Main$ServerResponse = F2(
	function (a, b) {
		return {allScores: a, timeLeftMs: b};
	});
var _user$project$Main$fetchDecoder = A3(
	...
	A3(
		...
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$ServerResponse)));
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {data: a, teamName: b, lastVote: c};
	});
var _user$project$Main$Scissors = {ctor: 'Scissors'};
var _user$project$Main$Paper = {ctor: 'Paper'};
var _user$project$Main$Rock = {ctor: 'Rock'};
var _user$project$Main$Reload = {ctor: 'Reload'};
var _user$project$Main$SetTeamName = function (a) {
	return {ctor: 'SetTeamName', _0: a};
};
var _user$project$Main$SetVoteResponse = function (a) {
	return {ctor: 'SetVoteResponse', _0: a};
};
var _user$project$Main$sendVote = F2(
	function (teamName, vote) {
		return A2(
			...
			function (_p8) {
				return _user$project$Main$SetVoteResponse(
					_krisajenkins$remotedata$RemoteData$fromResult(_p8));
			},
			A3(
				_elm_lang$http$Http$post,
				'http://10.112.157.157:8080/api/vote',
				A2(_user$project$Main$encodeBody, teamName, vote),
				_user$project$Main$sendDecoder));
	});
var _user$project$Main$FetchResponse = function (a) {
	return {ctor: 'FetchResponse', _0: a};
};
var _user$project$Main$fetch = A2(
	_elm_lang$http$Http$send,
	function (_p9) {
		return _user$project$Main$FetchResponse(
			_krisajenkins$remotedata$RemoteData$fromResult(_p9));
	},
	A2(_elm_lang$http$Http$get, 'http://10.112.157.157:8080/api/state', _user$project$Main$fetchDecoder));
var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{data: _krisajenkins$remotedata$RemoteData$Loading, teamName: 'My Team', lastVote: _elm_lang$core$Maybe$Nothing},
	{
		ctor: '::',
		_0: _user$project$Main$fetch,
		_1: {ctor: '[]'}
	});
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							lastVote: _elm_lang$core$Maybe$Just(_p11)
						}),
					{
						ctor: '::',
						_0: A2(_user$project$Main$sendVote, model.teamName, _p11),
						_1: {ctor: '[]'}
					});
			case 'FetchResponse':
				return A2(
...
var _user$project$Main$SetVote = function (a) {
	return {ctor: 'SetVote', _0: a};
};
var _user$project$Main$choiceBtn = F2(
	function (lastVote, vote) {
		return A2(
			_elm_lang$html$Html$button,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Main$SetVote(vote)),
				_1: {
					ctor: '::',
							...
							_1: {
								...
								_0: {
									...
									_1: _elm_lang$core$Native_Utils.eq(
										_elm_lang$core$Maybe$Just(vote),
										lastVote)
								},
								_1: {
									ctor: '::',
...
var _user$project$Main$choices = function (vote) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: A2(_user$project$Main$choiceBtn, vote, _user$project$Main$Rock),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Main$choiceBtn, vote, _user$project$Main$Scissors),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Main$choiceBtn, vote, _user$project$Main$Paper),
					_1: {ctor: '[]'}
				}
			}
		});
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('10.112.157.157'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
									...
									_1: {
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'border', _1: '3px solid black'},
													_1: {ctor: '[]'}
												}
											}
										}
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Rock, Paper, Scissors'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SetTeamName),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.teamName),
										_1: {
											ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$Main$choices(model.lastVote),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: A2(_user$project$Main$callWhenLoaded, _user$project$Main$showScores, model.data),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		...
		subscriptions: _elm_lang$core$Basics$always(
			A2(
				_elm_lang$core$Time$every,
				500,
				_elm_lang$core$Basics$always(_user$project$Main$Reload)))
	})();
